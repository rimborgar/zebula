/decl/cocktail/bogus
	...
	ratios = list(
		/decl/material/liquid/alcohol/blackstrap = 0.4,
		/decl/material/liquid/alcohol/gin =        0.2
	)
...
/decl/cocktail/alexander
	...
	ratios = list(
		/decl/material/liquid/alcohol/cognac   = 0.4,
...
/decl/cocktail/stag
	...
	ratios = list(
		...
		/decl/material/liquid/alcohol/rum =     0.2
	)
...
/decl/cocktail/lonestarmule
	...
	ratios = list(
		/decl/material/liquid/alcohol/whiskey  =  0.3,
...
/decl/cocktail/moscowmule
	...
	ratios = list(
		/decl/material/liquid/alcohol/vodka    =  0.3,
		/decl/material/liquid/drink/gingerbeer =  0.2,
		/decl/material/liquid/drink/juice/lime =  0.2
	)
...
/decl/cocktail/sidecar
	...
	ratios = list(
		...
		/decl/material/liquid/alcohol/bluecuracao = 0.2
	)
...
/decl/cocktail/daiquiri
	...
	ratios = list(
		/decl/material/liquid/alcohol/rum =           0.4,
		/decl/material/liquid/drink/juice/lime =      0.2,
...
/decl/cocktail/caesar
	...
	description = "Et tu?"
	ratios = list(
		/decl/material/liquid/alcohol/vodka =     0.4,
...
/decl/cocktail/caipirinha
	...
	ratios = list(
		/decl/material/liquid/alcohol/cachaca =  0.3,
...
/decl/cocktail/sangria
	...
	ratios = list(
		/decl/material/liquid/alcohol/wine =        0.6,
...
/decl/cocktail/carajillo
	...
	ratios = list(
		...
		/decl/material/liquid/alcohol/coffee =    0.2
	)
...
/decl/cocktail/qiiboxi
	...
	ratios = list(
		/decl/material/liquid/alcohol/qokkhrona =  0.6,
		/decl/material/liquid/drink/juice/orange = 0.2
	)
...
/decl/cocktail/sjikis
	...
	ratios = list(
		...
		/decl/material/liquid/alcohol/beer =      0.2,
...
/decl/cocktail/springpunch
	...
	ratios = list(
		/decl/material/liquid/alcohol/vodka =     0.5,
		/decl/material/liquid/drink/juice/lemon = 0.2,
...
/decl/cocktail/specialblend
	...
	ratios = list(
		/decl/material/liquid/alcohol/whiskey/mars = 0.5,
		/decl/material/liquid/drink/coffee =         0.3
	)